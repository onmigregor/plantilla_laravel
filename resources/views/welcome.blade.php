...
<html lang="en">
  <head>
    ...
    <!-- Main CSS-->
        ...
        <!-- The css style to display page loading on top-->
        <link href="{{ asset('css/style/pace-dark.css') }}" rel="stylesheet">
    <!-- Font-icon css-->
 ...
 <main class="app-content">
    ...
    <!-- Essential javascripts for application to work-->
      ...
      <!-- plugin para graficas en java script -->
      <script type="text/javascript" src="js/plugins/chart.js"></script>

       <!-- plugin para datatables  // tablas dinamicas-->
      <script type="text/javascript" src="js/plugins/jquery.dataTables.min.js"></script>
      <script type="text/javascript" src="js/plugins/dataTables.bootstrap.min.js"></script>
      <script type="text/javascript">$('#sampleTable').DataTable();</script>

      <!-- plugin para datapicker // calendarios dinamicos-->
      <script type="text/javascript" src="js/plugins/bootstrap-datepicker.min.js"></script>

        <!-- plugin para select2// selectores especiales-->
